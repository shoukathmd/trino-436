...
@Path("/ui/api/trino-query")
public class MWUiQueryResource
{
    ...
    @Inject
    public MWUiQueryResource(DispatchManager dispatchManager, AccessControl accessControl, HttpRequestSessionContextFactory sessionContextFactory)
    {
